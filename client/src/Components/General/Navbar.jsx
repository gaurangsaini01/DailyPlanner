...
function Navbar() {
    ...
    return (
        <div className='flex items-center bg-white dark:bg-amber-200 justify-between px-6 py-4'>
            <div className='text-xl font-semibold'>Welcome back, <span className='capitalize'>{user?.username}</span> 👋</div>
